...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno) {
        ...
        JLabel pa = new JLabel("PAN Number:");
        pa.setFont(new Font("Raleway", Font.BOLD,20));
        pa.setBounds(100, 440, 200, 30);
        add(pa);
        ...
        aadha.setFont(new Font("Raleway", Font.BOLD,20));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(eyes.isSelected()){
            existingaccount = "Maried";
        }else if(eno.isSelected()){
            existingaccount = "Unmaried";
        }
